          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <DateSelect name="anmeldung_start" required value={formData.anmeldung_start} onChange={handleChange} className={inputClass} />
              </div>
              <div>
                <label className={labelClass}>Anmeldung Ende *</label>
                <DateSelect name="anmeldung_ende" required value={formData.anmeldung_ende} onChange={handleChange} className={inputClass} />
              </div>
            </div>
